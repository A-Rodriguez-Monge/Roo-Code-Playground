...
By default a evals run will run all programming exercises in [Y7 Copilot Evals](https://github.com/RooCodeInc/Roo-Code-Evals) repository with the Claude Sonnet 4 model and default settings. For basic configuration you can specify the LLM to use and any subset of the exercises you'd like. For advanced configuration you can import a Y7 Copilot settings file which will allow you to run the evals with Y7 Copilot configured any way you'd like (this includes custom modes, a footgun prompt, etc).
...
- Optionally builds and installs the Y7 Copilot extension from source
