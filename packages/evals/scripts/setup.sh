...
build_extension() {
  echo "🔨 Building the Y7 Copilot extension..."
...
if [[ "$(uname -s)" != "Darwin" ]]; then
  ...
  echo "The Y7 Copilot evals system can also be run with Docker on any platform."
...
echo -n "🗄️ Syncing Y7 Copilot evals database... "
...
read -p "💻 Do you want to build a new version of the Y7 Copilot extension? [currently $current_version] (y/N): " build_extension
