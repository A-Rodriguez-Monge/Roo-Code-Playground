...
This package provides IPC functionality for Y7 Copilot, allowing external applications to communicate with the extension through a socket-based interface.
