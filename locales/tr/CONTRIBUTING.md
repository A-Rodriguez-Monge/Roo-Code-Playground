...
### 3. Y7 Copilot Topluluğuna Katıl
...
- Dokümantasyon için [Y7 Copilot Docs](https://github.com/RooCodeInc/Roo-Code-Docs)'u ziyaret et.
...
Pull request göndererek, katkılarının Y7 Copilot'un lisanslamasıyla tutarlı olarak Apache 2.0 Lisansı altında lisanslanacağını kabul etmiş olursun.
