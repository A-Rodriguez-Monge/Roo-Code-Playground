...
### 3. Unisciti alla community Y7 Copilot
...
- Per la documentazione, visita [Y7 Copilot Docs](https://github.com/RooCodeInc/Roo-Code-Docs).
...
Inviando una pull request, accetti che i tuoi contributi siano concessi in licenza sotto la Licenza Apache 2.0, in linea con la licenza di Y7 Copilot.
