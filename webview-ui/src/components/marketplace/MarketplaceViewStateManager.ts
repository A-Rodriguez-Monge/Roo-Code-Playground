 ...
 *
 * This class manages the state for the marketplace view in the Y7 Copilot extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Y7 Copilot extensions interface
