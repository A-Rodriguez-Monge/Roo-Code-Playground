...
const DESCRIPTION =
	"Terms of Service for Y7 Copilot Cloud. Learn about our service terms, commercial conditions, and legal framework."
const PATH = "/terms"
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						Y7 Copilot Cloud Terms of Service
					</h1>
					...
					<ul className="lead">
						<li>
							...
							executed by Y7 Copilot and the customer that references these TOS; <strong>and</strong>
						</li>
						<li>
							<strong>(b)</strong> any{" "}
					...
					<p>
						If Y7 Copilot and Customer later execute a Master Subscription Agreement (&quot;
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">
										Y7 Copilot maintains commercially reasonable administrative, physical, and
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Y7 Copilot <strong>does not</strong> use Customer Content to train, fine-tune,
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Y7 Copilot may identify Customer (name & logo) in marketing materials unless
					...
					<ol>
						...
						<li>
							...
							<br />
							Deleted – Y7 Copilot offers no trials, pilots, betas, or SLA credits under these TOS.
						</li>
						<li>
					...
					<p>
						...
						) explains how Y7 Copilot collects and handles personal information. If Customer requires a DPA,
						email{" "}
					...
					<ol>
						<li>
							...
							<br />
							Customer may not assign the Agreement without Y7 Copilot&apos;s prior written consent,
						...
						<li>
							...
							<br />
							Y7 Copilot may update these TOS by posting a revised version at the same URL and emailing or
