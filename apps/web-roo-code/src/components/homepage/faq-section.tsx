...
const faqs: FAQItem[] = [
	{
		question: "What exactly is Y7 Copilot?",
		answer: (
			<>
				Y7 Copilot is an open-source, AI-powered coding assistant that runs in VS Code. It goes beyond simple
	...
	{
		question: "How does Y7 Copilot differ from Copilot, Cursor, or Windsurf?",
		answer: (
			<>
				Y7 Copilot is <strong>open-source and fully customizable</strong>, letting you integrate any AI model
				...
				enabling it to run tests, open a browser, and handle deeper tasks. And you&apos;re always in control: Y7
				Copilot is <strong>permission-based</strong>, meaning you can control and approve any file changes or
				command executions.
			</>
		),
	},
	{
		question: "Is Y7 Copilot really free?",
		answer: (
			<>
				Yes! Y7 Copilot is completely free and open-source. You&apos;ll only pay for the AI model usage if you
	...
	},
	{
		...
		answer: (
			<>
				Yes. Because Y7 Copilot is an extension in your local VS Code, your code never leaves your machine
				unless you connect to an external AI API. Even then, you control exactly what is sent to the AI model.
				You can use tools like .rooignore to exclude sensitive files, and you can also run Y7 Copilot with
				offline/local models for full privacy.
			</>
		),
	},
	{
		question: "Which AI models does Y7 Copilot support?",
		answer: (
			<>
				Y7 Copilot is fully model-agnostic, giving you the flexibility to work with whatever AI models you
				...
				even connect any other model that follows Y7 Copilot&apos;s Model Context Protocol (MCP).
			</>
		),
	},
	{
		question: "Does Y7 Copilot support my programming language?",
		answer: (
			<>
				Likely yes! Y7 Copilot supports a wide range of languages—Python, Java, C#, JavaScript/TypeScript, Go,
	...
	},
	{
		...
		answer: (
			<>
				Absolutely. Y7 Copilot uses efficient strategies (like partial-file analysis, summarization, or
				...
				<Link href="/enterprise" className="text-primary underline-offset-4 hover:underline">
					Learn more about Y7 Copilot for enterprise.
				</Link>
			</>
		),
	},
	{
		...
		answer: (
			<>
				Yes. Y7 Copilot was built for enterprise environments. You can self-host AI models or use your own
				trusted provider. All file changes and commands go through permission gating, so nothing runs without
				your approval. And because Y7 Copilot is fully open-source, it&apos;s auditable—you can review exactly
	...
	{
		question: "Can Y7 Copilot run commands and tests automatically?",
		answer: (
			<>
				Yes! One of Y7 Copilot&apos;s biggest strengths is its ability to execute commands—always optional and
	...
	},
	{
		...
		answer: (
			<>
				Y7 Copilot shines for both serious enterprise development and casual &quot;vibe coding.&quot; You can
	...
	{
		question: "Can I contribute to Y7 Copilot?",
		answer: (
			<>
				Yes, please do! Y7 Copilot is open-source on{" "}
				<a
				...
				<div className="mx-auto mb-24 max-w-3xl text-center">
					<motion.div
						...
						<p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
							Everything you need to know about Y7 Copilot and how it can transform your development
							workflow.
						</p>
					</motion.div>
				</div>
